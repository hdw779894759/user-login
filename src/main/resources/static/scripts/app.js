...
var App = function () {
    ...
    // Handle exit funciton
    var handleExitSystem = function() {
        function toggleExitSystem() {
            if (confirm("退出网站吗？"))
            this.location.href = "logout.jsp";
        }

        $('#trigger_exitsystem').click(function() {
            toggleExitSystem();
        });
    }
    ...
    return {
        ...
        init: function () {
            ...
            handleExitSystem(); // handles exit function
        },
